...
![Go](https://github.com/lucidapp/wechatsdkgo/workflows/Go/badge.svg?branch=release-2.0)
...
[![pkg](https://img.shields.io/badge/dev-reference-007d9c?logo=go&logoColor=white&style=flat)](https://pkg.go.dev/github.com/lucidapp/wechatsdkgo/v2?tab=doc)
...
[API列表](https://github.com/lucidapp/wechatsdkgo/tree/v2/doc/api)
...
```
import "github.com/lucidapp/wechatsdkgo/v2"
```
...
- 在[API列表](https://github.com/lucidapp/wechatsdkgo/tree/v2/doc/api)中查看哪些API未实现
- 提交issue，描述需要贡献的内容
- 完成更改后，提交PR
